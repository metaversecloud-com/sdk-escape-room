  ...
  return (
    <div className="card w-full">
      <div className="card-details">
        ...
        <div className="mt-4">
          <label htmlFor="final-code" className="label">
            Enter final 4-digit code
          </label>
          <input
            id="final-code"
        ...
        {feedback && (
          <p className={`p1 ${isSolved ? "text-green-500" : "text-red-500"} mt-2`}>{feedback}</p>
        )}

        <div className="mt-4">
          <button className="btn btn-text" onClick={() => setShowHint(!showHint)}>
